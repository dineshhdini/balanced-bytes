...
""",
    ...
    with col4:
        ...
        eating_habits_val = st.selectbox("What are your typical eating habits?",['eats out frequently','cooks at home','skips meals'])
        ...
        if supplements_val:
            supplements_val = "user takes vitamin or supplement"
        else :
            supplements_val = "user does not take vitamin or supplement"
        pregnant_val = st.checkbox("Are you currently pregnant, breastfeeding, or planning to become pregnant?")
        if pregnant_val:
            pregnant_val = "user is pregnant"
        else:
            pregnant_val = "user is not pregnant"
            ...
            if name_val != '':
                ...
                if response.status_code == 200:
                    ...
                    st.write("To check a product?"
                        f'''
                            <a style="" target="_self" href="/image_process">
